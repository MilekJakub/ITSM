...
namespace ITSM.Areas.Identity.Pages.Account
{
    public class RegisterEmployeeModel : PageModel
    {
        ...
        public async System.Threading.Tasks.Task OnGetAsync(string returnUrl = null)
        {
            ...
            var jobPositions = _dbContext.JobPositions.ToList();
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.JobPositionId = Input.JobPositionId;
