...
{
    public partial class MigrateToSQLite : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Value = table.Column<string>(type: "TEXT", maxLength: 25, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", nullable: false),
                    Priority = table.Column<int>(type: "TINYINT", nullable: false),
                    Discriminator = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    Effort = table.Column<int>(type: "TINYINT", nullable: true),
                    Activity = table.Column<int>(type: "INTEGER", maxLength: 50, nullable: true),
                    RemainingWork = table.Column<int>(type: "TINYINT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "GETUTCDATE()"),
